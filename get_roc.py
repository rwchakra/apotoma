...
x_test_corrupted = np.load('ood_data/adversarial/mnist/mnist_base_model_adv_0.03.npy')
...
x_test_corrupted = np.load('ood_data/adversarial/mnist/mnist_finetuned_base_model_adv_0.03.npy')
x_test_corrupted = (x_test_corrupted / 255.0)
x_test_corrupted = x_test_corrupted.astype("float32")
