...
x_test_corrupted = np.load('ood_data/adversarial/cifar10/outexp_nosmcifar_adv_0.1.npy')
...
x_test_corrupted = np.load('ood_data/adversarial/cifar10/outexp_nosmcifar_finetune_adv_0.1.npy')
x_test_corrupted = (x_test_corrupted / 255.0)
x_test_corrupted = x_test_corrupted.astype("float32")
